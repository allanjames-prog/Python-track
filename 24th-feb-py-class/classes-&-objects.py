...
2. ABTSRACTION
Abstraction is the process of simplifying complex systems by hiding the unnecessary details and showing only the essential features. In OOP, abstracting the implementation of objects allows the programmer to focus on the higher-level functionalities.
...
4. POLYMOPHISM
Polymorphism means "many shapes", and it allows different classes to define methods that share the same name but have different implementations. This means you can use the same method name on objects of different classes, but each class can provide its own behavior for that method.
